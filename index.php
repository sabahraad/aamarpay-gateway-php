                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form class="requires-validation" action="process.php" method="post">
                            ...
                            <div class="col-md-12">
                                <input class="form-control" type="email" name="cus_email" placeholder="E-mail Address" required> 
                            </div>                   
                           <div class="col-md-12">
                              <input class="form-control" type="text" name="amount" placeholder="amount" required>
                           </div>
                           <div class="col-md-12">
                           <select class="form-select"  type="text" name="currency" placeholder="currency" required>
                           ...
                           <div class="col-md-12">
                              <input class="form-control mb-2" type="text" name="cus_phone" placeholder="Phone Number" required>
                           </div>
